    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50 p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent mb-4">
            QR Code Examples
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {examples.map((example, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white/70 backdrop-blur-lg rounded-2xl p-6 border border-blue-100 hover:shadow-xl hover:shadow-blue-200/20 transition-all duration-300 group"
              >
        ...
        <div className="mt-12 sm:mt-16 text-center">
          ...
          <Link
            to="/get-started"
            className="inline-flex items-center px-6 sm:px-8 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-medium rounded-xl shadow-lg hover:from-blue-700 hover:to-cyan-700 transition-all transform hover:scale-105"
          >
            Get Started Now
          </Link>
        </div>
        ...
        <div className="mt-16 sm:mt-20 grid md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 text-center">
          <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 border border-blue-100 hover:shadow-lg transition-all duration-300">
            <h3 className="text-slate-800 font-semibold mb-2">Dynamic Updates</h3>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 border border-blue-100 hover:shadow-lg transition-all duration-300">
            <h3 className="text-slate-800 font-semibold mb-2">Customization</h3>
            <p className="text-slate-600">
