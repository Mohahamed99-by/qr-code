...
const LandingPage = () => {
  ...
  return (
    <>
      <SEO 
        title="QR Code Generator & Scanner - Create Free QR Codes Online"
        description="Generate and scan QR codes instantly with our free online tool. Create QR codes for websites, text, and more. Easy to use, no registration required."
        keywords="QR code generator, QR scanner, free QR codes, create QR code, QR code maker"
      />
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-purple-50 to-pink-50">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-6 sm:gap-8 lg:gap-16">
              <div className="flex-1 space-y-4 sm:space-y-6 lg:space-y-8 text-center lg:text-left">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                  Generate <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600">Professional QR Codes</span> Instantly
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
                  ...
                  <Link 
                    to="/examples" 
                    className="inline-flex items-center justify-center px-4 sm:px-6 lg:px-8 py-3 sm:py-4 text-sm sm:text-base lg:text-lg font-medium text-gray-700 bg-white border-2 border-gray-200 rounded-xl hover:bg-purple-50 hover:border-purple-200 transition-all duration-300 w-full sm:w-auto transform hover:scale-105"
                  >
                    View Examples
                  </Link>
                </div>
              ...
              <div className="flex-1 relative w-full max-w-sm sm:max-w-md lg:max-w-none mx-auto mt-8 lg:mt-0">
                <div className="absolute inset-0 bg-gradient-to-r from-purple-200 to-pink-200 rounded-3xl transform rotate-6 scale-95 opacity-50 blur-xl"></div>
                <div className="relative bg-white p-3 sm:p-4 lg:p-8 rounded-3xl shadow-2xl hover:shadow-purple-500/20 transition-all duration-300">
                  {isImageLoading && (
        ...
        {/* Features Section */}
        <section className="py-8 sm:py-12 lg:py-20 bg-gradient-to-br from-white to-purple-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-12 max-w-5xl mx-auto">
              <div className="p-4 sm:p-6 lg:p-8 rounded-2xl bg-white backdrop-blur-lg bg-opacity-70 hover:shadow-xl transition-all duration-300 flex flex-col items-center sm:items-start text-center sm:text-left transform hover:scale-105 border border-purple-100">
                <Shield className="text-purple-600 mb-3 sm:mb-4 lg:mb-6 w-8 h-8 sm:w-10 sm:h-10" />
              ...
              <div className="p-4 sm:p-6 lg:p-8 rounded-2xl bg-white backdrop-blur-lg bg-opacity-70 hover:shadow-xl transition-all duration-300 flex flex-col items-center sm:items-start text-center sm:text-left transform hover:scale-105 border border-purple-100">
                <BarChart className="text-purple-600 mb-3 sm:mb-4 lg:mb-6 w-8 h-8 sm:w-10 sm:h-10" />
              ...
              <div className="p-4 sm:p-6 lg:p-8 rounded-2xl bg-white backdrop-blur-lg bg-opacity-70 hover:shadow-xl transition-all duration-300 flex flex-col items-center sm:items-start text-center sm:text-left transform hover:scale-105 border border-purple-100">
                <QrCode className="text-purple-600 mb-3 sm:mb-4 lg:mb-6 w-8 h-8 sm:w-10 sm:h-10" />
